         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Change Text Password</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                 <form action="change-tpassword.php" method="POST">
                                     
                                        <input type="hidden" class="form-control input-rounded" name="email"  required="required" value=<?php echo $xx['email'];  ?>  >

                                    <div class="form-group">
                                        <p class="text-muted m-b-15 f-s-12">Password :</p>
                                        <input type="text" class="form-control input-rounded" name="password"required="required" value=<?php echo $xx['password']; ?> >
                                    </div>
