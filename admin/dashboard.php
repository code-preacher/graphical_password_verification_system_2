            ...
            <div class="page-wrapper">
                        ...
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                 <a href="#"> <span><i class="fa fa-users f-s-50 color-success"></i></span></a>
                             </div>
                             <div class="media-body media-text-right">
                                <h2></h2>
                             <p class="m-b-0"><a href="view-application.php">Dashboard</a></p>
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class="col-md-3">
                <div class="card p-30">
                    <div class="media">
                        <div class="media-left meida media-middle">
                           <a href="change-tpassword.php">   <span><i class="fa fa-refresh f-s-50 color-warning"></i></span></a>
                       </div>
                       <div class="media-body media-text-right">
                         <h2></h2>
                     <p class="m-b-0"><a href="change-tpassword.php">Change Text Password</a></p>
                 </div>
             </div>
         </div>
     </div>
                ...
                <div class="card p-30">
                    <div class="media">
                        <div class="media-left meida media-middle">
                           <a href="change-ipassword.php">   <span><i class="fa fa-refresh f-s-50 color-dark"></i></span></a>
                       </div>
                       <div class="media-body media-text-right">
                         <h2></h2>
                     <p class="m-b-0"><a href="change-ipassword.php">Change Image Password</a></p>
                 </div>
             </div>
         </div>
     </div>
